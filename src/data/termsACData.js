const termsACData = [
  ...
  },
  {
    ...
    p: 'For the purposes of these Terms and Condition. Affiliate means an entity that controls, is controlled by or is under common control with a party, where "control" means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.',
  },
  {
    p: "Country refers to: Telangana, India",
  },
  {
    p: 'Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to the localbookstore.',
  },
  {
    p: "Device means any device that can access the Service such as a computer, a cellphone or a digital tablet.",
  },
  {
    subtitle: "Service refers to the Website",
    p: 'Terms and Conditions (also referred as "Terms") mean these Terms and Conditions that form the entire agreement between You and the Company regarding the use of the Service. This Terms and Conditions agreement has been created with the help of the Terms and Conditions Generator.',
  },
  {
  ...
  {
    p: "Website refers to The indian bookstore, accessible from http://www.mysite.com      ",
  },
  {
  ...
  {
    subtitle: '"AS IS" and "AS AVAILABLE" Disclaimer.',
  ...
  {
    subtitle: "For European Union (EU) Users",
  ...
  {
    subtitle: "United States Legal Compliance",
  ...
  {
    subtitle: "Changes to These Terms and Conditions",
